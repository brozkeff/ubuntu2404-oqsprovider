...
# consulted: {list everyone whose opinions are sought (typically
# subject-matter experts); and with whom there is a two-way communication}
# informed: {list everyone who is kept up-to-date on progress; and with whom
# there is a one-way communication}
---
<!-- we need to disable MD025, because we use the different heading -->
<!-- "ADR Template" in the homepage (see above) than it is foreseen -->
<!-- in the template -->
...
- [+] {positive consequence, e.g., improvement of one or more desired
  qualities, …}
...
confirmed. Is the chosen design and its implementation in line with the
decision? E.g., a design/code review or a test with a library such as ArchUnit
can help validate this. Note that although we classify this element as
...
<!-- use [+] prefix for "Good, because" -->
- [+] {argument a}
- [+] {argument b}
<!-- use "neutral" if the given argument weights neither for good nor bad -->
- [0] {argument c}
<!-- use [-] prefix for "Bad, because" -->
- [-] {argument d}
